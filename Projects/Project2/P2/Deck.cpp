...
void playFlip()
{
    ...
    cout << "Drawing your 24 cards..." << endl;
    cout << endl;
    for (int i = 0; i < 24; i++)
    {
        draws.push_back(deck.deal());
    }

    for (int i = 0; i < 24; i++)
    {
        char play;
        cout << "Drawing card " << i + 1 << "..." << endl;
        cout << "Flip or end game (Y or N)";
        cin >> play;

        if (play == 'Y' || play == 'y')
        {
            Card drawnCard = draws[i];
            ...
            if (drawnCard.getSuit() == "Heart")
            {
                points += 1;
            }
            deck.replace(drawnCard);
            cout << drawnCard;
            cout << "Your score: " << points << endl;
            cout << endl;
        }
        if (i == 23 || play == 'N' || play == 'n')
        {
            ...
            cout << endl;
            cout << "Remaining cards of the deck:" << endl;
            cout << deck;
